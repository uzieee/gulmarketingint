      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary-600 hover:text-white transition-colors duration-300 shadow-md">
                <Facebook size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary-600 hover:text-white transition-colors duration-300 shadow-md">
                <Twitter size={18} />
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#microbiology" className="hover:text-primary-400 hover:translate-x-1 inline-flex items-center transition-all duration-300"><ArrowRight size={14} className="mr-2 text-primary-500" /> Clinical Microbiology</a></li>
              <li><a href="#hematology" className="hover:text-primary-400 hover:translate-x-1 inline-flex items-center transition-all duration-300"><ArrowRight size={14} className="mr-2 text-primary-500" /> Hematology</a></li>
              <li><a href="#chemistry" className="hover:text-primary-400 hover:translate-x-1 inline-flex items-center transition-all duration-300"><ArrowRight size={14} className="mr-2 text-primary-500" /> Chemistry</a></li>
              <li><a href="#team" className="hover:text-primary-400 hover:translate-x-1 inline-flex items-center transition-all duration-300"><ArrowRight size={14} className="mr-2 text-primary-500" /> Our Team</a></li>
            </ul>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-800/50 hover:bg-gray-800 transition-colors border border-gray-800">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">+92-51-4426080<br/>+92-51-4426587</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-800/50 hover:bg-gray-800 transition-colors border border-gray-800 overflow-hidden">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm truncate">
                      <a href="mailto:Gmi786@yahoo.com" className="hover:text-primary-400">Gmi786@yahoo.com</a><br/>
                      <a href="mailto:Gmi786@gmail.com" className="hover:text-primary-400">Gmi786@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm tracking-wide">
            © 2024 Gulf Marketing International. All rights reserved. | Design by GMI.
          </p>
