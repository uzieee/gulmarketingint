...
const Team = () => {
  ...
  return (
    <section className="py-24 bg-primary-50 relative overflow-hidden" id="team">
      <div className="absolute top-0 left-0 w-64 h-64 bg-primary-200/50 rounded-full mix-blend-multiply filter blur-3xl opacity-50 -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-80 h-80 bg-primary-300/40 rounded-full mix-blend-multiply filter blur-3xl opacity-50 translate-x-1/4 translate-y-1/4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight">
            Meet Our{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-primary-800">Team</span>
          </h2>
          ...
          {teamMembers.map((member, idx) => (
            ...
            >
              ...
              <div className="relative mx-auto w-40 h-40 mb-6">
                <div className="absolute inset-0 bg-primary-100 rounded-full scale-105 group-hover:scale-110 transition-transform duration-500" />
                <img
                  src={member.image}
                  alt={member.name}
              ...
              <div className="flex justify-center gap-4 opacity-70 group-hover:opacity-100 transition-opacity duration-300">
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:text-white hover:bg-red-500 transition-colors"
                >
                  <Mail size={18} />
                </a>
                <a
                  href={member.social.linkedin}
                  className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:text-white hover:bg-blue-600 transition-colors"
                >
                  <Linkedin size={18} />
                </a>
                <a
                  href={member.social.twitter}
                  className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:text-white hover:bg-sky-500 transition-colors"
                >
                  <Twitter size={18} />
                </a>
              </div>
